...
It produces the `teklive-demo-1.0-SNAPSHOT-runner.jar` file in the `/target` directory. Be aware that it’s not an _
...
The application is now runnable using `java -jar target/teklive-demo-1.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./target/teklive-demo-1.0-SNAPSHOT-runner`
